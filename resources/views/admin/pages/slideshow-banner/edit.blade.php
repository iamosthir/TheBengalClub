    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Edit Slideshow Banner</h3>
            ...
            <!-- /.card-header -->
            <form action="{{ route('admin.slideshow-banner.update', $banner->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="extra_text" id="extra_text"
                                  ...
                                  rows="3"
                                  placeholder="Enter additional text">{{ old('extra_text', $banner->extra_text) }}</textarea>
                        @error('extra_text')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" name="enable_action_button" id="enable_action_button"
                                   ...
                                   {{ old('enable_action_button', $banner->enable_action_button) ? 'checked' : '' }}
                    ...
                    <div id="action-fields" style="display: {{ old('enable_action_button', $banner->enable_action_button) ? 'block' : 'none' }};">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" name="action_link" id="action_link"
                                   ...
                                   value="{{ old('action_link', $banner->action_link) }}">
                            @error('action_link')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        <label for="image">Change Banner Image (PNG, JPG, JPEG)</label>
                        ...
                        <small class="form-text text-muted">Accepted formats: PNG, JPG, JPEG. Max size: 2MB. Leave empty to keep current image.</small>
                    </div>
