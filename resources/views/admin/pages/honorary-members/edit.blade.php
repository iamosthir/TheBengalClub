...
@section('title', 'Edit Honorary Member')

@section('content')
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6"><h1 class="m-0">Edit Honorary Member</h1></div>
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Edit: {{ $honoraryMember->name }}</h3>
            ...
            <form action="{{ route('admin.honorary-members.update', $honoraryMember) }}" method="POST" enctype="multipart/form-data">
                @csrf @method('PUT')
                <div class="card-body">
                    @if(session('success'))
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                       value="{{ old('name', $honoraryMember->name) }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div id="designation-list">
                                    @php
                                        $existingDesignations = old('designation', $honoraryMember->designation ?? ['']);
                                        if (!is_array($existingDesignations)) $existingDesignations = [$existingDesignations];
                                        if (empty($existingDesignations)) $existingDesignations = [''];
                                    @endphp
                                    @foreach($existingDesignations as $des)
                    ...
                    <div class="form-group">
                        ...
                        @if($honoraryMember->photo_path)
                            <div class="mb-2">
                                <img id="photo-preview" src="{{ asset('storage/' . $honoraryMember->photo_path) }}"
                                     alt="{{ $honoraryMember->name }}" class="img-thumbnail" style="max-height:120px;">
                            </div>
                        @else
                            <div class="mb-2">
                        ...
                        <div class="input-group">
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label" for="photo">Change photo (leave blank to keep current)</label>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="bio" class="form-control" rows="3">{{ old('bio', $honoraryMember->bio) }}</textarea>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="order" min="0" class="form-control"
                                       value="{{ old('order', $honoraryMember->order) }}">
                            </div>
                        </div>
                        <div class="col-md-4 d-flex align-items-center mt-3">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="is_active" name="is_active"
                                       {{ old('is_active', $honoraryMember->is_active) ? 'checked' : '' }}>
