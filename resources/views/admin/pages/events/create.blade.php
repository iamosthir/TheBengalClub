        ...
        <div class="card">
            ...
            <form action="{{ route('admin.events.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="thumbnail">Event Thumbnail <span class="text-danger">*</span></label>
                        ...
                        <small class="form-text text-muted">
                            Main event image. Formats: JPG, JPEG, PNG. Max: 5MB.
                        </small>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" id="fee-field" style="{{ old('is_free', true) ? 'display:none;' : '' }}">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">
                                    Send email notification to all registered users about this event.
                                </small>
                            </div>
                        </div>
                    </div>
