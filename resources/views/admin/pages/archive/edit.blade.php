    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Edit Archive Item</h3>
            ...
            <form action="{{ route('admin.archive.update', $archive->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="order" id="order"
                               ...
                               value="{{ old('order', $archive->order) }}" min="0" required>
                        @error('order')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="form-group">
                        <label for="image">Replace Image (PNG, JPG, JPEG)</label>
