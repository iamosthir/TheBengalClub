    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Add New Membership Category</h3>
            ...
            <form action="{{ route('admin.membership-categories.store') }}" method="POST">
                @csrf
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="bio" id="bio"
                                  ...
                                  rows="4"
                                  placeholder="Enter category description">{{ old('bio') }}</textarea>
                        @error('bio')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" name="optional_installment" id="optional_installment"
                                   class="custom-control-input"
                                   value="1"
                                   {{ old('optional_installment') ? 'checked' : '' }}>
