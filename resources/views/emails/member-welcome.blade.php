...
<head>
    ...
    <title>Welcome to The Bengal Club</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        <div class="email-header">
            <h1>🎉 Welcome to The Bengal Club!</h1>
            <p style="margin: 5px 0 0 0;">Your Membership Account Has Been Created</p>
        </div>

        <div class="email-body">
            <h2>Dear {{ $user->name }},</h2>

            <p>Congratulations! You are now a member of <strong>The Bengal Club</strong>. We are delighted to welcome you to our distinguished community.</p>

            <div class="credentials-box">
                <h3>Your Login Credentials</h3>
                <p>You can access your member account using the following credentials:</p>
            ...
            <div class="membership-details">
                ...
                <table>
                    <tr>
                        ...
                        <td><strong>{{ $membershipCategory->title }}</strong></td>
                    </tr>
                    <tr>
                        <td>Membership Duration:</td>
                        <td><strong>{{ $membershipCategory->duration }}</strong></td>
                    </tr>
                    <tr>
                        <td>Membership Fee:</td>
                        <td><strong>৳{{ number_format($membershipCategory->price, 2) }}</strong></td>
                    </tr>
                    <tr style="border-bottom: none;">
                        <td>Registration Date:</td>
                        <td><strong>{{ $user->created_at->format('F j, Y') }}</strong></td>
                    </tr>
                </table>
            </div>
